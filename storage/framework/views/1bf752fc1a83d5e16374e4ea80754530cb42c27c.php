      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item ml-auto">
            <a class="nav-link" href="<?php echo e(url('vendedores')); ?>">Vendedores</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <br>
   ...
   <div class="row justify-content-center">
    ...
    <?php
      ...
      ?>
      <form method="POST" action = "<?php echo e(action('VendedorController@update', $v->id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\oficina\resources\views/vendedor/update.blade.php ENDPATH**/ ?>