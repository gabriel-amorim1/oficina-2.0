...
<html lang="pt">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item ml-auto">
            <a class="nav-link" href="<?php echo e(url('pesquisaVendedores')); ?>">Pesquisar por vendedores Cadastrados</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <br>
   ...
   <div class="row justify-content-center">
      ...
      <form method="POST" action = "<?php echo e(action('VendedorController@create')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\oficina\resources\views/vendedor/cadastrarVendedor.blade.php ENDPATH**/ ?>