      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item ml-auto">
            <a class="nav-link" href="<?php echo e(url('pesquisa')); ?>">Pesquisar por orçamentos</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <br>
   ...
   <div class="row justify-content-center">
    ...
    <?php
      ...
      ?>
      <form method="POST" action = "<?php echo e(action('OrcamentoController@update', $o->id)); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\oficina\resources\views/orcamento/update.blade.php ENDPATH**/ ?>