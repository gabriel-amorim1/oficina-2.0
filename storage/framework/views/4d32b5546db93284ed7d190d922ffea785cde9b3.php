...
<!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item ml-auto">
            <a class="nav-link" href="<?php echo e(url('cadastrar')); ?>">Cadastrar Orçamentos</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <form method="POST" action = "<?php echo e(action('OrcamentoController@retornoPesquisa')); ?>">
					...
					<tr>
						<td>
						  	<?php
								...
								echo '</pre>';
							?>
							<a href="<?php echo e(action('OrcamentoController@destroy', $o->id)); ?>" class = "btn btn-outline-danger">Excluir</a>
							<a href="<?php echo e(action('OrcamentoController@redirectToUpdate', $o->id)); ?>" class = "btn btn-outline-info">Editar</a>
					    </td>
					 	<td>
						  	<?php
...
<?php /**PATH C:\xampp\htdocs\oficina\resources\views/orcamento/index.blade.php ENDPATH**/ ?>